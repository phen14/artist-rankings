...
public class LastFmTrack {
    ...
    public Track toTrack() {
        // If no date is present, it means the track is currently playing.
        LocalDateTime time = (date == null) ? LocalDateTime.now() : date.getTime();
        return new Track(artist.getName(), name, time);
    }
